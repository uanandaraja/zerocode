...
export const api = {
  ...
  github: {
    ...
    getSlashCommands: { useQuery: (_input?: unknown, _opts?: unknown) => ({ data: [] as Array<{ id: string; name: string; command: string; description: string; path?: string; repository?: string; category: "builtin" | "repository" }>, isLoading: false }) },
